...
namespace Yajat.Digitalizers.ExpressionProcessor.Service
{
    ...
    /// </summary>
    internal sealed class ExpressionProcessor : StatelessService, IExpressionProcessor
    {
        private readonly IExpressionProcessor _Impl;
        private readonly ILogger<IExpressionProcessor> _Logger;

        public ExpressionProcessor(StatelessServiceContext context, ILogger<IExpressionProcessor> logger)
            : base(context)
        {
            _Logger = logger ?? throw new ArgumentNullException(nameof(logger));           
            _Impl = new Impl.ExpressionProcessor(logger);
