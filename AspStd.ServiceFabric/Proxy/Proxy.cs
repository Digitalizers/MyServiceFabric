...
namespace Yajat.Digitalizers.AspStd.ServiceFabric.Proxy
{
    public class Proxy
    {
        ...
        public static I ForComponentDirect<I>(ServicePartitionKey partitionKey = null) where I : class, IService
        {
            //Debug.Assert(caller != null, "Invalid component call. Must supply stateless service caller.");
            return ForService<I>(new Uri($"fabric:/MyServiceFabric/ExpProcessor"), partitionKey);
        }
