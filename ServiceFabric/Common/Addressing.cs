...
namespace Yajat.Digitalizers.Commons.ServiceFabric.Common
{
    public static class Addressing
    {
        ...
        public static Uri Component<I>(Microsoft.ServiceFabric.Services.Runtime.StatelessService caller) where I : IService
        {
            Debug.Assert(typeof(I).IsInterface);
